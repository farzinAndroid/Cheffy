package com.farzin.cheffy.utils

import com.farzin.cheffy.BuildConfig
...
object Constants {
    ...
    const val DATABASE_NAME = "resipe_db"
    const val PLACEHOLDER = "https://spoonacular.com/recipeImages/667707-312x231.jpg"
